...
export const metadata: Metadata = {
  title: "Visit Jordan | Your Guide to Jordan's Best Destinations",
  description: "Explore Jordan's destinations and activities with our comprehensive travel guide.",
  icons: {
    icon: [
      { url: "/favicon.ico" },
