...
export function ContactForm({
  title = "Contact Us",
  subtitle = "Have questions about this itinerary? Send us a message and we'll get back to you soon.",
}) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Tell us about your travel plans, preferences, and any special requests..."
            rows={4}
            required
          />
        </div>
